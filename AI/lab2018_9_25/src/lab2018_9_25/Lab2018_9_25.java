...
for(int i=0;i<13;i++)//shows the list of cities
 if(i==12){
     System.out.println("the "+retCity(i)+ "["+i+"]");
             }  
 else
System.out.println(retCity(i)+ " city["+i+"]");
System.out.print("\nInput: ");
cityChoice=inp.nextInt();//User's choice of the list
if(cityChoice<0 ||cityChoice>=13)//the user choice is not included in the list
{
System.out.println("Mistake,run the program again");
System.exit(0);
}
lab2018_9_25 traGraph=new lab2018_9_25(13,cityChoice);
traGraph.lab2018_9_25();
}
